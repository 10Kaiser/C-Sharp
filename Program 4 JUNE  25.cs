...
namespace OOPProgramming
{
    ...
    //    {
    //        Console.WriteLine(x + y + z + "i2");
    //        return (x + y + z);

    //    }
    //    public double add(double x, double y, double z)
    //    {
    //        Console.WriteLine(x + y + z + "d2");
    //        return (x + y + z);
    ...
    //    static void Main()
    //    {
    //        Calculation type1 = new Calculation();
    //        type1.add(5, 5);
    //        type1.add(5.7, 5.9);
    //        type1.add(9,10,100);
    //        type1.add(5.55, 9.73, 3.18);                  
